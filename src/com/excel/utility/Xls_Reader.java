...
//these are utlities created with the help of API called Apache POI library.Java Based.
public class Xls_Reader {
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			// if (cell.getCellTypeEnum().STRING != null)

			// if(cell.getCellTypeEnum()==Xls_Reader.CELL_TYPE_STRING)
			// return cell.getStringCellValue();
